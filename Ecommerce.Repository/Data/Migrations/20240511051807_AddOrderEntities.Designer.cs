...
namespace Ecommerce.Repository.Data.Migrations
{
    ...
    [Migration("20240511051807_AddOrderEntities")]
            ...
            modelBuilder.Entity("Ecommerce.Core.Entities.Order.Order", b =>
                {
                    ...
                    b.OwnsOne("Ecommerce.Core.Entities.Order.Address", "shippingAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("Ecommerce.Core.Entities.Order.OrderItem", b =>
                {
                    ...
                    b.OwnsOne("Ecommerce.Core.Entities.Order.ProductItemOrder", "Product", b1 =>
                        {
